![header](https://capsule-render.vercel.app/api?type=soft&color=0:0d1117,100:21262d&height=150&section=header&text=JunHyeong_LEE&fontSize=55&fontColor=ffffff&animation=fadeIn&fontAlignY=55&desc=Cloud%20Infrastructure%20%7C%20AWS%20%7C%20Kubernetes%20%7C%20Monitoring&descSize=18&descAlignY=75&descColor=58a6ff)

## 👋 About Me
- 🎓 **Focus:** Cloud Infrastructure Engineering, AWS Architecture, Container Orchestration & Observability
- 🔄 **Background:** 2+ years RPA Development → Cloud/Infrastructure Engineering
...
### 🏭 StockOps ERP — 멀티 하이브리드 클라우드 인프라
> K-Food 수출 기업 모델 기반 ERP/WMS 솔루션 | 팀 프로젝트 (팀명: 시선)

- **AWS EKS** 기반 4개 마이크로서비스 컨테이너 오케스트레이션
- **CloudTrail → CloudWatch → Lambda → Teams** 실시간 보안 감사 알림 파이프라인 구축
- **Prometheus + Grafana** EKS 인프라 모니터링 스택 구성 (커스텀 대시보드 포함)
- **Terraform IaC** 전체 인프라 코드화 (모듈 구조)
- **GitHub Actions OIDC** Access Key 없는 보안 CI/CD 파이프라인
...
- AWS Multi-region connectivity with TGW & VPN
- Automation Scripts: Multi-distro package management & Server monitoring
